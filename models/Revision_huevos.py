...
class Revision_huevos(Base_table):
    ...
    estado_huevo_id = Column(Integer, ForeignKey('estados_huevos.id_estado_huevo'), nullable=False, name="estado_huevo_id")
    estado_huevo = relationship("Estados_huevos", backref="revision_huevos", lazy=True)
