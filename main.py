...
app.include_router(revision_huevos_router, prefix="/revision_huevos", tags=["Revision_huevos"])
app.include_router(estados_huevos_router, prefix="/estados_huevos", tags=["Estados_huevos"])
app.include_router(alertas_router, prefix="/alertas", tags=["Alertas"])
app.include_router(estado_alerta_router, prefix="/estado_alerta", tags=["Estado_alerta"])
app.include_router(tipo_alerta_router, prefix="/tipo_alerta", tags=["Tipo_alerta"])
app.include_router(tipo_ave_router, prefix="/tipo_ave", tags=["Tipo_ave"])
app.include_router(tipo_estado_alerta_router, prefix="/tipo_estado_alerta", tags=["Tipo_estado_alerta"])
app.include_router(tipo_lectura_router, prefix="/tipo_lectura", tags=["Tipo_lectura"])
app.include_router(caracteristicas_incubacion_router, prefix="/caracteristicas_incubacion", tags=["Caracteristicas_incubacion"])
